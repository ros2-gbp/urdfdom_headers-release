## urdfdom_headers (rolling) - 3.0.1-1

The packages in the `urdfdom_headers` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling urdfdom_headers` on `Thu, 30 Jul 2026 07:15:55 -0000`
...
## urdfdom_headers (jazzy) - 1.1.3-1

The packages in the `urdfdom_headers` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy urdfdom_headers` on `Tue, 02 Jun 2026 04:37:46 -0000`
...
## urdfdom_headers (rolling) - 3.0.0-1

The packages in the `urdfdom_headers` repository were released into the `rolling` distro by running `/usr/local/google/home/scpeters/ws/venv_bloom/bin/bloom-release --rosdistro rolling urdfdom_headers` on `Mon, 20 Apr 2026 21:50:23 -0000`
...
## urdfdom_headers (rolling) - 2.1.1-1

The packages in the `urdfdom_headers` repository were released into the `rolling` distro by running `/usr/local/google/home/sloretz/projects/lyrical/env3/bin/bloom-release urdfdom_headers --rosdistro rolling --track rolling` on `Wed, 15 Apr 2026 01:38:16 -0000`
...
## urdfdom_headers (rolling) - 2.1.0-1

The packages in the `urdfdom_headers` repository were released into the `rolling` distro by running `/usr/local/google/home/scpeters/ws/venv_bloom/bin/bloom-release --rosdistro rolling urdfdom_headers` on `Mon, 02 Feb 2026 21:41:03 -0000`
...
## urdfdom_headers (rolling) - 2.0.1-1

The packages in the `urdfdom_headers` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling urdfdom_headers` on `Fri, 28 Nov 2025 09:44:00 -0000`
...
## urdfdom_headers (rolling) - 2.0.0-1

The packages in the `urdfdom_headers` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling urdfdom_headers` on `Tue, 01 Jul 2025 17:54:17 -0000`
